    ...
    return Padding(
      ...
      child: ListView(
        children: [
          ...
          SizedBox(height: 10),
          SettingsCard(
            leading: FaIcon(FontAwesomeIcons.share, size: 20,),
            title: AppLocalizations.of(context)!.share,
            onTap: () {
              if(Platform.isAndroid){
                Share.share('سجل علي تفويض الأن واطلب عمرة. https://play.google.com/store/apps/details?id=com.taffweed.taffweed');
              }
              else if(Platform.isIOS){
                Share.share('سجل علي تفويض الأن واطلب عمرة. https://apps.apple.com/eg/app/taffweed/id6538714711');
              }
            },
          ),
          SizedBox(height: 10),
          SettingsCard(
            leading: FaIcon(FontAwesomeIcons.star, size: 20,),
