                        ...
                        return Column(
                          children: [
                            CustomButton(
                              ...
                              onPressed: () async {
                                orderCubit.payNow(context, widget.request, "Card");
                              },
                            ),
                            Divider(height: 40,),
                            CustomButton(
                              bgColor: Colors.red.shade400,
                              icon: FaIcon(FontAwesomeIcons.googlePay, size: 30),
                              text: "Google Pay",
                              onPressed: () async {
                                orderCubit.payNow(context, widget.request, "Google");
                              },
                            ),
                            SizedBox(height: 10,),
                            if(Platform.isIOS)
                              CustomButton(
                                ...
                                text: "Apple Pay",
                                icon: FaIcon(FontAwesomeIcons.applePay, size: 30),
                                onPressed: () async {
                                  orderCubit.payNow(context, widget.request, "Apple");
                                },
                              ),
                          ],
                        );
