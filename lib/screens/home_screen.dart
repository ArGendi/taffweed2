...
import 'package:tafweed/local/cache.dart' as myCache;
...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin{
  ...
  void didChangeDependencies() {
    ...
    String? notification;
    if(myCache.Cache.getToken() != null){
      notifications = myCache.Cache.getNotifications() ?? [];
      ...
      myCache.Cache.setNotifications(notifications);
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: currentPage == 4 ? FloatingActionButton(
        onPressed: (){
