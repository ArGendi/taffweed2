...
class ProfileCubit extends Cubit<ProfileState> {
  ...
  void onEdit(BuildContext context) async{
    try{
      ...
      if(password.isEmpty){ // AppLocalizations.of(context)!.
        ScaffoldMessenger.of(context).showSnackBar(customSnackBar(AppLocalizations.of(context)!.nothing_new_to_change ,mainColor));
        return;
      }
