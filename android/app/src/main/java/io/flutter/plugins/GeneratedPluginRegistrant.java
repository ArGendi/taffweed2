...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.myfatoorahflutter.myfatoorah_flutter.MyfatoorahFlutterPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin myfatoorah_flutter, com.myfatoorahflutter.myfatoorah_flutter.MyfatoorahFlutterPlugin", e);
    }
    try {
